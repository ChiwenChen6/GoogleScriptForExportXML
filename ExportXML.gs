...
function doGet(e)
{
  if (e.parameter.setting == "english") {
    var contentoutput = exportSheet(e,0);
    var output =  ContentService.createTextOutput(contentoutput); 
    output.setMimeType(ContentService.MimeType.XML);
    output.downloadAsFile("string.xml");    
  }
  else if (e.parameter.setting == "chinese") {
    var contentoutput = exportSheet(e,1);
    var output =  ContentService.createTextOutput(contentoutput); 
    output.setMimeType(ContentService.MimeType.XML);
    output.downloadAsFile("string.xml");   
  }    
  else if (e.parameter.setting == "japanese") {
    var contentoutput = exportSheet(e,2);
    var output =  ContentService.createTextOutput(contentoutput); 
    output.setMimeType(ContentService.MimeType.XML);
    output.downloadAsFile("string.xml");   
  }
